...
\begin{enumerate}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{../diagram/Q1/imp_resp.png}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{../diagram/Q1/freq_resp.png}
    ...
    \item (Step 3) To show how you determine the word-length, please use the word-length of coefficients as the X-axis and error as the Y-axis. Scan the quantization error versus the word-lengths from 9 bits to 15 bits (Four figures each having 7 word-length settings in its x-axis). According the following simulation results, mark the final word-length settings in the block diagram of the direct form FIR filter. (20\%)
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.8\textwidth]{../diagram/Q5/behav_sim_output.png}
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.8\textwidth]{../diagram/Q5/behav_sim_output_error.png}
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.8\textwidth]{../diagram/Q6/post_syn_sim_output.png}
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.8\textwidth]{../diagram/Q6/post_syn_sim_output_error.png}
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.8\textwidth]{../diagram/Q8/post_syn_sim_output_of_2_paral.png}
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.8\textwidth]{../diagram/Q8/post_syn_sim_output_error_of_2_paral.png}
