...
\begin{enumerate}
    ...
    Combined with the sign bit, the complete word format is (1 sign $+$ 1 integer $+$ 10 fractional) $= 12$ bits.
    ...
    \begin{figure}[htbp]
        \centering
        % \includegraphics[width=1.0\textwidth]{../diagram/Q3/error_vs_S.png}
        \caption{Average phase error versus number of micro-rotations $S$}
        \label{fig:error_vs_S}
    \end{figure}

    \begin{figure}[htbp]
        \centering
        % \includegraphics[width=1.0\textwidth]{../diagram/Q3/error_vs_angle_wordlength.png}
        \caption{Average phase error versus word-length of quantized elementary angles}
